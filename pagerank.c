...
pagerank_data_t *initialize_pagerank_data(int m0, int k0)
{
  ...
  pagerank_data_sequential->buff = (float *)calloc(sizeof(float),
						   m0*2);
  ...
  fill_sequences_normalized( m0,
			     1, pagerank_data_sequential->x );
...
void copy_pagerank_data(pagerank_data_t *pagerank_data_dst, pagerank_data_t *pagerank_data_src )
{
  ...
  memcpy(pagerank_data_dst->buff,
	 pagerank_data_src->buff,
	 buff_size);
}
...
pagerank_data_t *clone_pagerank_data(pagerank_data_t *pagerank_data_src)
{
  ...
  pagerank_data_dst->buff = (float *)calloc(sizeof(float),
					    m0*2);
